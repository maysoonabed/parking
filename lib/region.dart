      ...
      home: Scaffold(
        ...
        body:ListView.builder(
          ...
          itemBuilder: (context, i) {
            regRef.child('region').child(inBus[i].region).child(inBus[i].uid).onValue.listen((event) {
              setState(() {
                inBus[i].taken=event.snapshot.value!=null?event.snapshot.value.toDouble():0;
               });
            });
                ...
                child: ListTile(
                  // leading: FlutterLogo(size: 56.0),
                    ...
                    trailing: CircularPercentIndicator(
                      radius: 50.0,
                      lineWidth: 5.0,
                      percent:  inBus[i].taken/double.parse(inBus[i].passengers),
